...
namespace CoinsOrganizerDesktop.Helpers
{
    /// <summary>
    ...
    public class ActionCommand<T> : ICommand where T : class
    {
        ...
        public void Execute(object parameter)
        {
            ...
            if (parameter != null && param == null)
                throw new InvalidOperationException("Wrong type of parameter being passed in.  Expected [" + typeof(T) +
                                                    "]but was [" + parameter.GetType() + "]");
